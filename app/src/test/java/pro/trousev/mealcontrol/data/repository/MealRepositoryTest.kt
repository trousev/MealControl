...
class MealRepositoryTest {
    ...
    @Test
    fun saveMeal_insertsMealAndComponents() =
        runBlocking {
    ...
    @Test
    fun getAllMeals_returnsEmptyListWhenNoMeals() =
        runBlocking {
            val meals = repository.getAllMeals()
    ...
    @Test
    fun getAllMeals_returnsMealsSortedByTimestamp() =
        runBlocking {
    ...
    @Test
    fun getMealById_returnsCorrectMeal() =
        runBlocking {
    ...
    @Test
    fun getMealById_returnsNullForNonExistent() =
        runBlocking {
    ...
    @Test
    fun deleteMeal_removesMealAndComponents() =
        runBlocking {
    ...
    @Test
    fun saveMeal_withEmptyComponents_works() =
        runBlocking {
    ...
    @Test
    fun saveMeal_withManyComponents_works() =
        runBlocking {
    ...
    @Test
    fun getMealById_returnsMealWithComponents() =
        runBlocking {
            val mealId =
                repository.saveMeal(
                    "photo",
