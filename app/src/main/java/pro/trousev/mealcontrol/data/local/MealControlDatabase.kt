    ...
    companion object {
        ...
        private val MIGRATION_2_3 =
            object : Migration(2, 3) {
                override fun migrate(database: SupportSQLiteDatabase) {
                    database.execSQL(
                        "ALTER TABLE meal_components ADD COLUMN proteinGrams INTEGER NOT NULL DEFAULT 0",
                    )
                    database.execSQL(
                        "ALTER TABLE meal_components ADD COLUMN fatGrams INTEGER NOT NULL DEFAULT 0",
                    )
                    database.execSQL(
                        "ALTER TABLE meal_components ADD COLUMN carbGrams INTEGER NOT NULL DEFAULT 0",
                    )
                }
            }
        ...
        private val MIGRATION_3_4 =
            object : Migration(3, 4) {
                override fun migrate(database: SupportSQLiteDatabase) {
                    database.execSQL(
                        "ALTER TABLE meals ADD COLUMN conversationId INTEGER",
                    )
                }
            }
        ...
        private val MIGRATION_4_5 =
            object : Migration(4, 5) {
                override fun migrate(database: SupportSQLiteDatabase) {
                    database.execSQL(
                        "ALTER TABLE meals ADD COLUMN proteinGrams INTEGER NOT NULL DEFAULT 0",
                    )
                    database.execSQL(
                        "ALTER TABLE meals ADD COLUMN fatGrams INTEGER NOT NULL DEFAULT 0",
                    )
                    database.execSQL(
                        "ALTER TABLE meals ADD COLUMN carbGrams INTEGER NOT NULL DEFAULT 0",
                    )
                }
            }
        ...
        private val MIGRATION_5_6 =
            object : Migration(5, 6) {
                override fun migrate(database: SupportSQLiteDatabase) {
                    database.execSQL(
                        "ALTER TABLE conversations ADD COLUMN isMealDetection INTEGER NOT NULL DEFAULT 0",
                    )
                }
            }
